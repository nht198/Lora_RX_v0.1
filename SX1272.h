...
const uint32_t CH_00_433 = 0x6C8000; //chanel 12 ,central freq = 433.00MHZ
const uint32_t CH_01_433 = 0x6C8C3B; //chanel 12 ,central freq = 434.19MHZ
const uint32_t CH_02_433 = 0x6C9907; //chanel 12 ,central freq = 434.39MHZ
const uint32_t CH_03_433 = 0x6CA5D4; //chanel 12 ,central freq = 434.59MHZ
const uint32_t CH_04_433 = 0x6CB2A1; //chanel 12 ,central freq = 434.79MHZ
const uint32_t CH_05_433 = 0x6D7F6E; //chanel 12 ,central freq = 437.99MHZ
